...
from prodigy_local.modules.aa_properties import aa_character_ic, aa_character_hydro, aa_character_protorp
from prodigy_local.modules.freesasa_tools import execute_freesasa_api
from prodigy_local.modules.models import IC_NIS
from prodigy_local.modules.utils import dg_to_kd
...
class Prodigy:
    ...
    def print_prediction(self, outfile: str = "", quiet: bool = False, showall: bool = False) -> None:
        ...
        if quiet:
            ...
            # Use a Windows-friendly degree symbol (U+00B0) instead of U+02DA
